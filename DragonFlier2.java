 ...
 * @version May 2022
 */
public class DragonFlier2 extends Arraylist
{
    ...
    private class GamePane extends JPanel  {
        private String message = "Hi Everyone! This is the game that I have created! " +
                "This game revolves around 'You' as the Dragon to eat all of the eggs when its ready! " +
                "You can press space bar to shoot fireballs, but keep in mind it has a cooldown! " +
                "The goal of this game is to eat all of the eggs on the map! " +
                "There are 12 eggs scattered around the map and you have to find them all " +
                "You have to eat the eggs when they are ripe! If you don't eat them in time, Monsters will come and eat you " +
                "If you eat the eggs before they are ripe you will get negative points! " +
                "You can click 'R' to restart the game! and Press 'I' if you want to see the Instructions again!" +
                "";

        private Dragon dragon;
        private MessageBox messageBox; //Create instance of messageBox
        ...
        public GamePane() {
            ...
            Timer timer = new Timer(5, new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            background.move();
                            fireball.move();
                            messageBox.move(); //call the move method
        ...
        private void initialize(){
            ...
            this.messageBox = new MessageBox(FRAME_WIDTH,FRAME_HEIGHT,this.dragon,message);
            ...
            addKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_R, 0, true), "R pressed: restarting game", 
                                                                                new R_Action(this));
            addKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_I, 0, true), "I pressed: Showing Message",
                    new I_Action(messageBox)); //add a keybinding to 'I', so you can bring up the messagebox
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            for(int i = 0; i < eggList.size(); i++) {
                Egg thisEgg = (Egg) eggList.get(i);
                thisEgg.draw(g);
            }

            if (dragon.isFacingRight()) { //chooses the x location of the messagebox based off the direction.
                messageBox.loc.x = dragon.getLoc().x + 100;
            }
            else {
                messageBox.loc.x = dragon.getLoc().x - FRAME_WIDTH / 3 - 100;
            }

            this.messageBox.draw(g); //draws messagebox.
    ...
    /**
     * This is my I_Action class, this helps me create the key bindings for my 'I'
     * Key so that I can bring up and remove the messagebox in the game.
     */

    public class I_Action extends AbstractAction {
        MessageBox messageBox; //create instance of messagebox
        int counter = 0; //create counter

        /**
         * Constructor for the I_Action class
         *
         * pre: The messagebox object.
         * post: initializes the messagebox to this class.
         *
         * @param b
         */

        public I_Action(MessageBox b){
            this.messageBox = b;
        }

        /**
         * This is the overridden method of actionPerformed.
         * This method allows us to have it called whenever the key 'I' is pressed.
         * When It is pressed it shows the messagebox and when it does again it dissapears.
         *
         * pre: The action event which is the key 'I'
         * post: It either displays or hides the message box.
         *
        ...
        public void actionPerformed(ActionEvent e) {
            if (counter % 2 == 0) {
                System.out.println("You typed 'I' so MessageBox is shown");
                messageBox.display();
            }
            else {
                System.out.println("You typed 'I' again so MessageBox is deleted");
                messageBox.hide();
            }
            counter++;
        }
