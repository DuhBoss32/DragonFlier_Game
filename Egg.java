...
public class Egg extends DragonGameShape{
    ...
    private void loadImages(){
        try {
            ...
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall1.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall2.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall3.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall4.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall5.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall6.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall7.png")));
            this.creatureImageList.add(ImageIO.read(new File("src/images/creatureSmall8.png")));
            this.creatureImage = (BufferedImage) this.creatureImageList.get(0); // current image.
            
            this.creatureFireImageList.add(ImageIO.read(new File("src/images/creatureFire1.png")));
            this.creatureFireImageList.add(ImageIO.read(new File("src/images/creatureFire2.png")));
            this.creatureFireImageList.add(ImageIO.read(new File("src/images/creatureFire3.png")));
            this.creatureFireImageList.add(ImageIO.read(new File("src/images/creatureFire4.png")));
    ...
    public void creatureShot(){
        ...
        this.creatureImage = (BufferedImage) this.creatureFireImageList.get(0);
    ...
    private BufferedImage nextCreatureImage(){
        ...
        return (BufferedImage) this.creatureImageList.get(this.whichCreature);
    }
    ...
    private BufferedImage nextCreatureFireImage(){
        ...
        return (BufferedImage) this.creatureFireImageList.get(this.whichCreatureFire);
    }
