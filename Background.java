...
public class Background extends DragonGameShape{
    ...
    private void loadImages(){
        try {
            this.backgroundImage = ImageIO.read(new File("src/images/bigCavern01.png"));
            this.backgroundBackgroundImage = ImageIO.read(new File("src/images/backgroundbackground02.jpg"));
