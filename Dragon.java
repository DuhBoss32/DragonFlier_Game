...
public class Dragon extends DragonGameShape{
    ...
    private void loadImages(){
        try {
            ...
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon1Left.png")));
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon2Left.png")));
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon3Left.png")));
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon4Left.png")));
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon5Left.png")));
            leftDragonImageList.add(ImageIO.read(new File("src/images/dragon6Left.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon1Right.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon2Right.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon3Right.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon4Right.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon5Right.png")));
            rightDragonImageList.add(ImageIO.read(new File("src/images/dragon6Right.png")));

            this.dragonImage = (BufferedImage) leftDragonImageList.get(0);
    ...
    private BufferedImage nextLeftDragonImage(){
        ...
        return (BufferedImage) this.leftDragonImageList.get(this.whichDragon);
    }
    ...
    private BufferedImage nextRightDragonImage(){
        ...
        return (BufferedImage) this.rightDragonImageList.get(this.whichDragon);
    }
